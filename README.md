...
(Многопоточность реализована используя потоки С++11. Мультиплексирование с помощью структуры pollfd. Парсинг параметров команднной строки реализован при помощи getopt)
